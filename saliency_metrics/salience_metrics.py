...
#d_gt[gt>0]=1.0
	...
	sname = "./smap/{}.jpg".format(i)
	s_map = cv2.imread(sname,0)
...
print ('final sim score:', sim_score/5 )
print('final kld score:', kldiv_score/5)
print('final cc_score:', cc_score/5)
